  ...
  return (
    ...
    >
      <div className="min-w-0">
        ...
        <p className="mt-0.5 truncate text-[10px] font-bold text-text-muted uppercase tracking-wider">
      ...
      <ChevronRight
        className={cn("h-5 w-5 shrink-0 transition-all", active ? "text-brand" : "text-text-muted")}
        aria-hidden="true"
      />
    </Link>
  );
