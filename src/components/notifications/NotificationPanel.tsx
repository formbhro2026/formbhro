...
export function NotificationPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      ...
      className="absolute right-0 top-12 z-50 w-[min(20rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-border-subtle bg-surface-1 shadow-2xl duration-200 animate-in fade-in slide-in-from-top-2"
    >
