...
export function ConnectionGuide() {
  ...
  const connectionString =
    "postgresql://postgres:[YOUR-PASSWORD]@db.ogjhvmucklbxcewpkiai.supabase.co:5432/postgres";
        ...
        <Panel className="p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-text-secondary leading-relaxed bg-brand/5 border border-brand/10 rounded-lg p-3">
              <span className="font-semibold text-brand">Note:</span> If your database password
              contains special characters, percent-encode them in the connection string.
            </p>
          </div>
        </Panel>
        ...
        <Panel className="p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">
                Give AI coding tools ready-made instructions for Supabase.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <p className="text-sm text-text-secondary leading-relaxed">
              Agent Skills give AI coding tools ready-made instructions, scripts, and resources for
              working with Supabase more accurately and efficiently.
            </p>
