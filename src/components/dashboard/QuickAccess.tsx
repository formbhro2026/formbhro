...
export function QuickAccess() {
  return (
    <section>
      <h2 className="text-[11px] font-semibold uppercase tracking-[0.14em] text-text-muted">Quick Access</h2>
        ...
        {ITEMS.map((i) => {
          ...
          return (
            <li key={i.label}>
              ...
              >
                <Icon className="h-4 w-4 shrink-0 text-brand" strokeWidth={1.75} aria-hidden="true" />
