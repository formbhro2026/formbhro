...
const SUPABASE_URL = "https://ogjhvmucklbxcewpkiai.supabase.co";
const ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9namh2bXVja2xieGNld3BraWFpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODUxMzIzNTAsImV4cCI6MjEwMDcwODM1MH0.RksSzHe_ZYyhOT7NswqVlN52OF31lOUCJsrjmSURBRQ";
const SERVICE_ROLE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9namh2bXVja2xieGNld3BraWFpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4NTEzMjM1MCwiZXhwIjoyMTAwNzA4MzUwfQ.5GlZhJoR7Urcb6gRKPhiJ_OTh1MqJXC2Bw59pB4ZDLg";
